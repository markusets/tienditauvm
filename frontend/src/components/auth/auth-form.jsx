...
export default function AuthForms() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        const userRole = data.userDataSent.role; // Cambio aquí
        setRole(userRole);
        toast({
          title: "Registrado!",
        ...
        <div className="w-full max-w-sm p-8">
          {isLogin ? (
            <>
              ...
              <p className="text-gray-600 mb-6">Bienvenido de nuevo, ingresa tus datos!</p>
            ...
            <>
              <h1 className="text-2xl font-semibold mb-2">Bienvenido</h1>
              <p className="text-gray-600 mb-6">Ingresa tus detalles para el registro</p>
